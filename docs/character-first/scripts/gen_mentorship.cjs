...
const sessionsEN = [
  ...
  },
  {
    ...
    oefening: {
      ...
      tekst: 'Step 1: write WITHOUT filters what you want to achieve in sport. (Nothing is too big)\nStep 2: write WITHOUT filters what you want to achieve as a person outside sport.\nStep 3: from both lists choose your TOP 1 goal for this season and TOP 1 goal for 3 years from now.',
    },
    schrijfVragen: [
  ...
  },
  {
    ...
    opgelet: 'If self-criticism is extreme ("I\'m useless", "I don\'t deserve my spot"), normalize it, but flag this internally as a point of attention. Refer if needed.',
