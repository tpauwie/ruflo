...
const content = {
  EN: {
    ...
    sub: 'Sport is the perfect classroom for life. Most programmes develop athletic skills, not the person behind the jersey. Character First fills that gap. A complete, evidence-based character development system for young athletes aged 14 and above.',
    ...
    p2title: 'Four tracks.\nOne system.',
    p2intro: 'Character First offers four integrated programme tracks. They cover the team, the coach, and the individual player. Every track is available in Dutch and English. Each one comes with print-ready worksheets, facilitation guides, and mentorship tools.',
    tracks: [
      {
        icon: '📋', feat: true,
        title: 'Monthly character programme',
        sub: '8 sessions · Player + coach worksheets',
        desc: 'A full-season programme with 8 monthly themes: self-knowledge, stress and pressure, my role, communication, team first, resilience, leadership, and physical wellbeing. Includes player worksheets, coach facilitation guides, and combined full versions.',
      ...
      },
      {
        ...
        desc: 'Five structured sessions to build a strong team culture before the season starts: identity, team contract, trust and safety, conflict and recovery, and culture in action. Player and coach versions included.',
      ...
      },
      {
        ...
        desc: 'An in-depth personal development journey for coaches. 10 modules covering self-knowledge, feedback, emotional regulation, team dynamics, and mental health. Each module comes with books, TED Talks, podcasts, and weekly action tasks.',
    ...
    free: {
      ...
      items: [
        ...
        'Access to the Character First tools and brand',
      ],
    },
    prem: {
      label: '⭐ Premium, the full system',
      items: [
        ...
        'Priority support and custom content options',
      ],
    },
    ...
    steps: [
      { n: '1', t: 'Start free', d: 'Download all free worksheets in Dutch and English. No sign-up required.' },
      { n: '2', t: 'Choose a plan', d: 'Explore premium tracks for coaches, mentors, and clubs. Flexible pricing.' },
    ...
    footer: 'characterfirst.be · info@characterfirst.be · Created by Tom Pauwaert',
  },
  NL: {
    tagline: 'Win the person. Win the team.',
    hero: 'Wij trainen <span>karakter</span> zoals coaches techniek trainen.',
    sub: 'Sport is het perfecte klaslokaal voor het leven. De meeste programma\'s ontwikkelen sportieve vaardigheden, niet de persoon achter het shirt. Character First vult die leemte. Een compleet, evidence-based systeem voor karakterontwikkeling bij jonge sporters vanaf 14 jaar.',
    ...
    p2intro: 'Character First biedt vier geïntegreerde programmatrajecten. Ze zijn er voor het team, de coach en de individuele speler. Elk traject is beschikbaar in het Nederlands en Engels. Elk traject bevat drukklare werkbladen, begeleidingsgidsen en mentorshiptools.',
    tracks: [
      {
        icon: '📋', feat: true,
        title: 'Maandelijks karakterprogramma',
        sub: '8 sessies · Speler + coach werkbladen',
        desc: 'Een seizoensprogramma met 8 maandelijkse thema\'s: zelfkennis, druk en stress, mijn rol, communicatie, team eerst, veerkracht, leiderschap en fysiek welzijn. Inclusief spelerwerkbladen, coachgidsen en gecombineerde volledige versies.',
      ...
      },
      {
        ...
        desc: 'Vijf gestructureerde sessies om een sterke teamcultuur te bouwen vóór het seizoen: teamidentiteit, teamcontract, vertrouwen en veiligheid, conflict en herstel, en cultuur in actie. Speler- en coachversies inbegrepen.',
        tags: [{ t: 'Preseason', c: 'tag-g' }, { t: 'Team', c: 'tag-n' }],
      },
      {
        icon: '🎓', feat: false,
        ...
        desc: 'Een diepgaand persoonlijk ontwikkelingstraject voor coaches. 10 modules over zelfkennis, feedback, emotieregulatie, teamdynamiek en mentale gezondheid. Elke module komt met boeken, TED Talks, podcasts en wekelijkse actietaken.',
        tags: [{ t: 'Coach', c: 'tag-b' }, { t: '10 Modules', c: 'tag-n' }],
      },
      {
        icon: '🤝', feat: false,
    ...
    free: {
      ...
      items: [
        ...
        'Toegang tot de Character First tools en het merk',
      ],
    },
    prem: {
      label: '⭐ Premium, het volledige systeem',
      items: [
        ...
        'Prioritaire ondersteuning en op maat gemaakte inhoud',
      ],
    },
    ...
    steps: [
      { n: '1', t: 'Start gratis', d: 'Download alle gratis werkbladen in NL en EN. Geen registratie vereist.' },
      { n: '2', t: 'Kies een plan', d: 'Ontdek premium trajecten voor coaches, mentoren en clubs. Flexibele prijzen.' },
